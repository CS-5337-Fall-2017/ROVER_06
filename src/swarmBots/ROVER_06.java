 ...
 * @author rkjc
 * 
 * ROVER_06 is intended to be a basic template to start building your rover on
 ...
 * name "ROVER_06" to match your rovers name.
 * 
...
public class ROVER_06 extends Rover {
	...
	private void run() throws IOException, InterruptedException {
		...
		try {
			...
			while (true) {                     //<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
				...
				System.out.println("ROVER_06 ------------ end process control loop --------------"); 
		...
		// This catch block hopefully closes the open socket connection to the server
	        ...
	        if (socket != null) {
	            try {
	            	...
	            	System.out.println("ROVER_06 problem closing socket");
	            }
	        }
	    }
